/**
 * the import function below transfers the data from the data.js file 
 * and the assigns the data attributes diplayed in the html eg the
 * search function in the header bar, the images etc to certain parameters 
 * in the js  
 */
...
/**
 *  assigned varirables using const so that we can 
 * assign the document.queryselector for different elements
 */
...
const range = [0, BOOKS_PER_PAGE]  //books per page is limited to 36 in data
/**
 * the if! below will register taht if the books and array functions are missing, 
 * an error will occur
 */
...
/**
 * now well create a function called create preview so that we make a 
 * button object return
 * with all the preview info insition of the button in HTML
 */

/**
 * 
 * create preview is a single factory function as the function create preview is
 * creating the preview data by calling data and in the same FN it returns 
 * exactly the preview data in a preview form 
 * @returns 
 */
...
/**
 * the code below will create a start and end index variable
 */
...
/**
 * the code below will create a book fragment var and assign it 
 ...
 * appends the button to the bookFragment container using appendChild function
 */
...
/**
 * the code belowe will assign genre selection functionality to the 
 * selection panel : authors or genre
 */
